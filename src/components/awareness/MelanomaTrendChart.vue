<template>
  <section class="chart-card">
    <header class="chart-header">
      <h3 class="chart-title">Melanoma Cases in Victoria</h3>
      <p class="chart-subtitle">Trends by sex and total (persons)</p>
    </header>
    ...
    <div v-else class="chart-body">
      ...
      <p v-else class="chart-loading">Loading melanoma data...</p>
    </div>
  </section>
</template>
